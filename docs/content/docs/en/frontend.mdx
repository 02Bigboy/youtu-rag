...
{/* TODO: Add detailed file upload instructions */}
...
{/* TODO: Add detailed batch management instructions */}
...
{/* TODO: Add detailed knowledge base creation and deletion instructions */}
...
{/* TODO: Add detailed content association and vectorization instructions */}
...
{/* TODO: Add detailed Agent selection and usage instructions */}
...
{/* TODO: Add detailed memory function instructions */}
...
**Use Cases**:
{/* TODO: Add detailed use case descriptions */}
...
**Features**:
- Must select a knowledge base和文件
...
- Used to accumulate successful experiences
...
- **Zero Dependencies**: Pure native HTML + CSS + JavaScript implementation, no framework dependencies
- **Streaming Response**: Supports streaming output, real-time display of AI responses
